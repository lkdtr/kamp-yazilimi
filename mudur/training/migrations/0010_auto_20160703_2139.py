...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='course',
            name='question',
            field=models.ManyToManyField(to='mudur.Question', verbose_name='Question', blank=True),
        ),
        migrations.AlterField(
            model_name='course',
            name='textboxquestion',
            field=models.ManyToManyField(to='mudur.TextBoxQuestions', verbose_name='Text Box Questions', blank=True),
        ),
        migrations.AlterField(
            model_name='course',
            name='trainer',
