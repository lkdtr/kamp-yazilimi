...
urlpatterns = [
                       ...
                       url(r'^showuser/(?P<userid>[0-9]+)/(?P<courserecordid>[0-9]+)', userprofile_views.showuserprofile,
                       ...
                       url(r'^password/reset/key/(?P<key>[\w,-]+)/$', userprofile_views.password_reset_key_done,
